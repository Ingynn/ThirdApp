...
//    stationName[pathCus[i]]
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TrainDatabaseHandler dbhandler = new TrainDatabaseHandler(TrainListActivity.this);
        trainList=dbhandler.getMorning();

        recyclerView = (RecyclerView) findViewById(R.id.train_list_recycler);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(TrainListActivity.this));
        ...
        trainAdapter.setOnClickListener(new CustomClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(TrainListActivity.this);
                LayoutInflater inflater = TrainListActivity.this.getLayoutInflater();
...
//                String last = pathArr[pathArr.length - 1];
               ...
               /* statoolbar=(Toolbar)convertView.findViewById(R.id.statoolbar);
                ...
                RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(TrainListActivity.this);
                stationAdapter = new StationAdapter2(TrainListActivity.this, stationdataList);
                recyclerView.setHasFixedSize(true);
