 ...
 */
public class TrainListActivityEve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("TrainListActivity","Index ");
        TrainDatabaseHandler dbhandler = new TrainDatabaseHandler(TrainListActivityEve.this);
        trainList=dbhandler.getEvening();
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(TrainListActivityEve.this));
        ...
        trainAdapter.setOnClickListener(new CustomClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(TrainListActivityEve.this);
                LayoutInflater inflater = TrainListActivityEve.this.getLayoutInflater();
...
//                String last = pathArr[pathArr.length - 1];
               ...
               /* statoolbar=(Toolbar)convertView.findViewById(R.id.statoolbar);
                ...
                RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(TrainListActivityEve.this);
                stationAdapter = new StationAdapter2(TrainListActivityEve.this, stationdataList);
